...
Vendored from upstream `royerlab/cytoself`. Used as a reference
implementation for the Cytoself VQ-VAE training stack in
`scripts/07b_train_cytoself.py`. The README below is the upstream copy,
unmodified.
